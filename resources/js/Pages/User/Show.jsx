                        ...
                        <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            ...
                            <div className="grid gap-1 grid-cols-2 mt-2">
                                <div>
                                    ...
                                    <div>
                                        <label className="font-bold text-lg text-white">User ID</label>
                                        <p className="mt-1 text-white">{user.id}</p>                             
                                    </div>
                                    <div className="mt-4">
                                        <label className="font-bold text-lg text-white">User Name</label>
                                        <p className="mt-1 text-white">{user.name}</p>                             
                                    </div>
                                    <div className="mt-4">
                                        <label className="font-bold text-lg text-white">User Status</label>
                            ...
                            <div className="mt-4">
                                <label className="font-bold text-lg text-white"> User Description</label>
