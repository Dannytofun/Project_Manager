...
export default function TasksTable({
    ...
    return (
        <>
         {success && (<div className="bg-emerald-500 px-4 py-2 text-white rounded mb-4">{success}</div>
           )} 
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                key={task.id}>
                    ...
                    {!hideProjectColumn && (<td className="px-3 py-2 text-nowrap">{task.project.name}</td>
                    )}
